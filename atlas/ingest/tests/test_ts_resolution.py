"""GOALS.json C7 -- the permanent regression test for an earlier architecture-review finding. Run from the repo root:

    /path/to/venv/bin/python3 -m unittest atlas.ingest.tests.test_ts_resolution -v
"""
...
class TsResolutionDerivationTests(unittest.TestCase):
    ...
    def test_shell_writer_fake_precision_row_is_second(self):
        ...
        # epoch_ms -- a whole multiple of 1000. This is that finding's exact reproduction: 15,932
    ...
    def test_shell_writer_with_non_round_epoch_ms_is_microsecond(self):
        # Before the 2026-08-12T21:35 format change, the same
